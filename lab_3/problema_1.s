...
reset:
    ...
    // Configura los pines de las teclas como GPIO c/pull-up F0
...
systick_isr:
    ...
    MOV  R0,#LED_3_MASK         // Se carga la mascara para el LED 3
    STR  R0,[R1,#LED_N_OFFSET]  // Se invierte el bit GPIO del LED 3
