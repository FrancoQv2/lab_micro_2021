    ...
    .word   systick_isr+1       // 14: Pending service system trap service routine
...
// ----------------------------------------------------------------------------------
    ...
    MOV R0,#(MR3R | MR3I)           // reset y setear
    STR R0,[R1,#MCR]

    // Limpieza del contador
    MOV R0,#CRST            // reset timer counter y prescaler
    STR R0,[R1,#TCR]
...
timer_isr:
    ...
    BL   actualizar_hora        // Salto a actualizar_hora
    POP  {PC}
...
systick_isr:
    ...
    BEQ  systick_refrescar_displays             // Salto si 0
