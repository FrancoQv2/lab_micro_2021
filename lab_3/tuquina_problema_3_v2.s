...
horaActual:
        .byte 9                     // Hora en horaActual 
        .byte 59                    // Minuto en horaActual+1 
...
reset:
    ...
    STR R0,[R1,#(PUNTO_PORT << 7 | PUNTO_PIN << 2)]     //P4_6
...
/****************************************************************************/
    .func demora
demora:
    LDR R0, =10000      // Se carga el valor inicial de demora
lazo_demora:
